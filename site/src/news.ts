...
export const NEWS: NewsItem[] = [
  ...
  { date: '2020-02-09', kind: 'world', text: "'Parasite' becomes the first non-English-language film to win the Best Picture Oscar. A subtitled underdog takes the top prize; #727 is still waiting for its moment." },
