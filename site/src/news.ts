...
export const NEWS: NewsItem[] = [
  ...
  { date: '2018-05-15', kind: 'world', text: "The whole internet argues whether it hears 'Yanny' or 'Laurel.' #727 hears nothing back at all." },
  { date: '2019-01-23', kind: 'milestone', text: 'The legacy-homebrew repository, where the original link in #727 points, is retired.' },
  ...
  { date: '2021-03-23', kind: 'world', text: 'The container ship Ever Given wedges sideways across the Suez Canal, halting global trade for six days. #727 stays stuck a good deal longer.' },
  ...
  { date: '2025-04-04', kind: 'world', text: "'A Minecraft Movie' mines a record opening weekend as theaters erupt at 'Chicken jockey!' #727 still awaits its blockbuster moment." },
